...
public class ItemSearchBindingImpl extends ItemSearchBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.itemSearchTitle, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemSearch == variableId) {
            setItemSearch((com.zoe.wan.android.repository.data.SearchData) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemSearch(@Nullable com.zoe.wan.android.repository.data.SearchData ItemSearch) {
