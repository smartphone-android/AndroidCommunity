...
public class ActivityCollectBindingImpl extends ActivityCollectBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.collectBack, 1);
        sViewsWithIds.put(R.id.collectListView, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.myCollectVm == variableId) {
            setMyCollectVm((com.zoe.wan.android.activity.collect.MyCollectViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMyCollectVm(@Nullable com.zoe.wan.android.activity.collect.MyCollectViewModel MyCollectVm) {
        this.mMyCollectVm = MyCollectVm;
    }
